                        ...
                        <div className='bg-white p-3 sm:p-4 shadow-sm rounded-lg'>
                            ...
                            <div className='flex justify-between'>
                                <button className= 'btn bg-[#f1f5e8] flex items-center w-24'>
                                    <img className='w-[25px] h-[25px]' src={dbutton} alt="" />
                                    <p className=' text-[#00d390] text-xl'>{downloads}</p>
                                </button>
                                <button className='bg-[#fff0e1] btn w-24'>
                                    <img className='w-[25px] h-[25px]' src={star} alt="" />
                                    <p className='text-[#ff8811] text-xl px-1'>5</p>
                                </button>
                            </div>
                        </div>
                    </div>
